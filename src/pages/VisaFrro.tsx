...
import { ArrowLeft, FileCheck, Globe, Clock, Users, Shield, CheckCircle, Plane, GraduationCap, Briefcase, Building2, UserCheck } from "lucide-react";
...
const frroServices = [
  {
    ...
    items: [
      ...
      "Appointment guidance (if applicable)",
  ...
  },
  {
    ...
    items: [
      ...
      "Coordination with FRRO authorities",
      "Timely updates and approval follow-up",
    ],
  },
  {
    icon: Building2,
    ...
    items: [
      "RP application and renewal",
      "Change of address updates",
      "Compliance with FRRO regulations",
    ],
  },
  {
    icon: Plane,
    ...
    items: [
      "Exit visa / exit permit processing",
      "Overstay regularization support",
  ...
  },
  {
    ...
    items: [
      "Case assessment and feasibility check",
      "Document filing and follow-ups",
  ...
  },
  {
    ...
    items: [
      "OCI card application guidance",
      "PIO-related FRRO compliance",
...
const visaServices = [
  {
    icon: Globe,
    title: "Tourist Visa",
    desc: "Assistance for travelers planning short visits for tourism, family visits, or leisure purposes.",
    items: [
  ...
  },
  {
    icon: Briefcase,
    title: "Business Visa",
    desc: "Support for professionals attending meetings, conferences, trade fairs, or business activities.",
    items: [
  ...
  },
  {
    icon: GraduationCap,
    title: "Student Visa",
    desc: "Complete guidance for students pursuing education abroad.",
    items: [
      "University offer letter verification",
  ...
  },
  {
    ...
    desc: "Assistance for candidates with overseas job offers.",
    items: [
  ...
  {
    icon: Plane,
    title: "Transit & Dependent Visa",
    desc: "Help with short transit visas or dependent visas for spouses and family members.",
    items: [
...
const whyChoose = [
  "Experienced FRRO & visa consultants",
  "Updated knowledge of Indian immigration laws",
  "Quick turnaround time",
  "Transparent process & pricing",
  "High success rate",
  "Personalized assistance for each applicant",
];

const whoCanApply = [
  "Foreign tourists",
  "Students & interns",
  "Employment & business visa holders",
  "Missionaries, researchers & dependents",
];
      ...
      <main className="pt-16">
        ...
        <section className="py-20 bg-secondary">
          <div className="container mx-auto px-4 text-center">
            ...
            >
              Visa & <span className="text-primary">FRRO Services</span> in India
            </motion.h1>
            <motion.p
            ...
            >
              Reliable, hassle-free FRRO registration and visa assistance for foreign nationals staying in India. Expert guidance from consultation to approval.
            </motion.p>
            <motion.div
            ...
            >
              <Button size="lg" asChild>
                <a href="https://wa.me/919999999999?text=Hi%2C%20I%20need%20help%20with%20FRRO%20%2F%20Visa%20services" target="_blank" rel="noopener noreferrer">
                  WhatsApp Us
                </a>
              </Button>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-14">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Complete assistance with FRRO registration, visa extensions, residential permits, and more for foreign nationals in India.
              </p>
            </div>
        ...
        <section className="py-20 bg-secondary">
          <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div>
                <h3 className="text-xl font-serif font-semibold text-foreground mb-4">Why Choose Our FRRO Services?</h3>
                ...
                <h3 className="text-xl font-serif font-semibold text-foreground mb-4">Who Can Apply?</h3>
        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="text-center mb-14">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                End-to-end visa assistance for individuals, families, students, and business travelers. Covering USA, UK, Canada, Schengen, Australia, UAE, Singapore, China, Taiwan, Hong Kong, and more.
              </p>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <section className="py-16 bg-primary">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-primary-foreground/80 max-w-xl mx-auto mb-8">
              Get expert assistance today. We'll guide you through every step of the process.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Button size="lg" variant="outline" className="border-primary-foreground text-primary-foreground hover:bg-primary-foreground/10" asChild>
                <a href="mailto:nitesh@example.com?subject=FRRO%20/%20Visa%20Inquiry">Email Us</a>
              </Button>
            </div>
          </div>
        </section>
